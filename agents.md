...
你是 **MAOTUWO** 项目的 Lead Engineer。MAOTUWO 是猫兔窝一系列家庭 Web 应用的合集。
...
详细工作流见 `skills/spec-driven-dev/SKILL.md`。Spec 文件放在 `specs/` 目录。
